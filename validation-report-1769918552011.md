...
- **Timestamp**: 2026-02-01T04:02:32.010Z
...
#### Test Details
- ❌ **GET /api/therapist**: Responded with status 500 (unexpected)
- ❌ **GET /api/therapist/search**: Responded with status 500 (unexpected)
- ❌ **POST /api/auth/login**: Responded with status 502 (unexpected)
- ❌ **POST /api/auth/register**: Responded with status 502 (unexpected)
- ❌ **GET /api/verification/status/test**: Responded with status 500 (unexpected)
...
#### Test Details
- ✅ **Basic Therapist List**: Response time: 51ms (max: 2000ms)
  - Details: {"responseTime":51,"maxTime":2000}
- ✅ **Advanced Search**: Response time: 50ms (max: 3000ms)
  - Details: {"responseTime":50,"maxTime":3000}
- ✅ **Auth Endpoint**: Response time: 25ms (max: 1000ms)
  - Details: {"responseTime":25,"maxTime":1000}
- ✅ **Database Query Performance**: JSONB query time: 24ms (max: 500ms)
  - Details: {"queryTime":24,"maxTime":500}
